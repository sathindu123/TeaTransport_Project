...
public class InvoiceCustomerDto {
    ...
    public InvoiceCustomerDto(double teaPacketTotal, double fertilizeTotal, double otherTotal){
    ...
    public InvoiceCustomerDto(String date, int price){
        this.date = date;
        this.price = price;
    }
    ...
    public InvoiceCustomerDto( int price,int price1){
        this.price1 = price1;
        this.price = price;
    }
